...
//				parser.output();
			...
			for (Element element : animes) {
				...
				list.add(new WebAPICreateModel(title, week, time, station, next));	
			}
			isReady = true;
		}
